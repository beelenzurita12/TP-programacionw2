					...
					for($i = 0 ; $i < sizeof($data); $i++){
						$publicacion = "<div class='full-width post'>
											...
											<div class='full-width post-info'>
												...
												<a href='" . $GLOBALS["root"] . "mis_publicaciones/editar?id=" . $data[$i]["id"] . "' class='post-info-editar'>Editar</a>
												<a href='" . $GLOBALS["root"] . "mis_publicaciones/eliminar?id=" . $data[$i]["id"] . "' class='post-info-eliminar'>Eliminar</a>
