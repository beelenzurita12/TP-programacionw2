<section class="full-width section">
	<div class="container">
		...
		<div class="row">
            ...
            <button type="button" id="button1" class="btn btn-outline-danger ml-3">Exportar PDF</button>

            <div class="col-xs-12 col-sm-12 col-md-12 my-4" id="container-graphic2"></div>
            <button type="button" id="button2" class="btn btn-outline-danger ml-3">Exportar PDF</button>

            <div class="col-xs-12 col-sm-12 col-md-12 my-4" id="container-graphic3"></div>
            <button type="button" id="button3" class="btn btn-outline-danger ml-3">Exportar PDF</button>
