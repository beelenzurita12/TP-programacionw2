				...
				<div class="col-xs-12 col-sm-8">
					...
					<div id="slider-commercial" class="carousel slide" data-ride="carousel">
					  	...
					  	<div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item active" style="background-image: url('<?php echo $GLOBALS['root'] . "public/image/articulo1.jpg" ?>')">
                            </div>
                            <div class="carousel-item" style="background-image: url('<?php echo $GLOBALS['root'] . "public/image/articulo1.jpg" ?>')">
                            </div>
                            <div class="carousel-item" style="background-image: url('<?php echo $GLOBALS['root'] . "public/image/articulo1.jpg" ?>')">
                            </div>
					  	</div>
